...
function networkDown() {
	...
	sudo docker-compose -f /home/atri/workspace_hlf/shipping-network/docker/docker-compose-pkcs11-hsm.yaml down --volumes --remove-orphans
	rc=$?
...
function bringUpFabricCA() {
		...
		CA_IMAGETAG="latest"
		COMPOSE_FILE_CA=/home/atri/workspace_hlf/shipping-network/docker/docker-compose-ca-pkcs11.yaml
...
function networkUp() {
	...
	export IMAGETAG=latest
	sudo IMAGE_TAG=$IMAGETAG docker-compose -f /home/atri/workspace_hlf/shipping-network/docker/docker-compose-pkcs11-hsm.yaml up -d 2>&1
	rc=$?
