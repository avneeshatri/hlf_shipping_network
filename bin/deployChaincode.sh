...
peer lifecycle chaincode approveformyorg -o localhost:8051 --ordererTLSHostnameOverride orderer.pinkflyod.com --channelID $CHANNEL_NAME --name $CHAINCODE_NAME --version ${vs} --package-id $CC_PACKAGE_ID --sequence ${seq} --tls --cafile ${ORDERER_CA}
